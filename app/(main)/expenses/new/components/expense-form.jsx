...
const ExpenseForm = ({ type, onSuccess }) => {
    ...
    const onSubmit = async (data) => { 
        try {
            ...
            // Validate the splits add up to the total (with small tolerance)
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className='space-y-4'>
                ...
                {/* Participants for individual expense */}
                {type === "individual" && (
                    <div className="space-y-2">
                ...
                <div className="space-y-2">
                    ...
                    <Tabs defaultValue="equal"
                        ...
                        <TabsList className="gris w-full grid-cols-3">
                        ...
                        <TabsContent value="percentage" className="pt-4">
                            ...
                            <SplitSelector
                                ...
                                participants={participants}
                                paidByUserId={paidByUserId}
                                onSplitsChange={setSplits} // Use setSplits direclty
                            />
                        </TabsContent>
