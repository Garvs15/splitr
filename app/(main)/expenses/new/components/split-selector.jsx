...
const SplitSelector = ({
    ...
    // Calculates splits when inputs change
    useEffect(() => {
        ...
        if (type === "equal") {
            // Equal Splits
            const sharedAmount = amount / participants.length;
            ...
            // Initialize percenatge splits evenly
    ...
    const updatePercentageSplit = (userId, newPercentage) => {
        // Update just this user's percentage nd recalculate amount
    ...
    const updateExactSplit = (userId, newAmount) => {
        ...
        // Update just this user's amount and recalculate percenatge
        const updatedSplits = splits.map((split) => {
            if (split.userId === userId) {
                return {
                    ...split,
    ...
    // Check if the totals are valid
    const isPercenatgeValid = Math.abs(totalPercentage - 100) < 0.01;
        ...
        <div className='space-y-4 mt-4'>
            ...
            <div className="flex justify-between border-t pt-3 mt-3">
                ...
                <div className="text-right">
                    ...
                    {type !== "equal" && (
                        <span className={`text-sm ml-2 ${!isPercenatgeValid ? "text-amber-600" : ""}`}>
            ...
            {/* Validation warnings */}
            {type === "percentage" && !isPercenatgeValid && (
