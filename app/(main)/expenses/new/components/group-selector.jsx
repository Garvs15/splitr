...
const GroupSelector = ({ onChange }) => {
    ...
    // Single query to get all data user need
    ...
    if (!data?.groups || data.groups.length === 0) {
        return (
            <div className="text-sm text-amber-600 p-2 bg-amber-50 rounded-md">
                You need to create a group first adding a group expense.
            </div>
        );
    }
    ...
    return (
        <div>
            <Select key={selectedGroupId} onValueChange={handleGroupChange}>
