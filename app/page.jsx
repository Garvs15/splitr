    ...
    <div className="flex flex-col pt-16">
      ...
      <section id="features" className="bg-gray-50 py-20">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <div className="mx-auto mt-12 items-center grid max-w-5xl gap-6 md:grid-cols-2 lg:grid-cols-3">
      ...
      <section id="how-it-works" className="py-20">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <div className="mx-auto mt-12 items-center grid max-w-5xl gap-8 lg:grid-cols-3">
            {STEPS.map(({ description, label, title }) => (
              <div key={title} className="flex flex-col items-center space-y-4">
                <div
                  className="flex h-12 w-12 items-center justify-center rounded-full 
               bg-green-100 text-xl font-bold text-green-600"
                >
                  {label}
                </div>
                <h3 className="text-xl font-bold">{title}</h3>
      ...
      {/* Footer */}
      <footer className="border-t bg-gray-50 py-12 text-center text-sm text-muted-foreground font-semibold">
        Made by the Garv Singla 🚀🎉
      </footer>
    </div>
  );
}
